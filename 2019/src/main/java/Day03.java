...
public class Day03 {
    ...
    private class Position {
        ...
        private Position getNext(char direction) {
            switch (direction) {
                default:
    ...
    private class Wire {
        ...
        private List<Position> getTracks() {
    ...
    Set<Position> getIntersections(Wire wire1, Wire wire2) {
        List<Position> tracks1 = wire1.tracks;
        List<Position> tracks2 = wire2.tracks;

        Set<Position> intersections = new HashSet<>(tracks1);
        intersections.retainAll(new HashSet<>(tracks2));
